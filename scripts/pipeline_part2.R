...
Barcodes corresponding to doublet cells were identified using the union of two methods: scDblFinder (",sobj@misc$technical_info$scDblFinder,") using default parameters, and scds (",sobj@misc$technical_info$scds,") with its hybrid method using default parameters. However boublets were not discarded.")
