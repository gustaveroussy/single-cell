...
if(any(file.exists(paste0(dirname(vdj.input.files.tcr), "/Materials_and_Methods.txt")))){
  tmp2=c()
  for (nb_file in 1:length(dirname(vdj.input.files.tcr))){
    if(file.exists(paste0(dirname(vdj.input.files.tcr[nb_file]), "/Materials_and_Methods.txt"))){
