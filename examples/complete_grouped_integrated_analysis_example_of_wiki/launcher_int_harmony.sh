...
##
## using: sbatch /mnt/beegfs02/userdata/m_aglave/pipeline/bigr_single-cell/2.0.0/examples/complete_grouped_integrated_analysis_example_of_wiki_old/launcher_int_harmony.sh
##
########################################################################

## JOB PARAMETERS >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

#SBATCH --job-name=dev_harmony
#SBATCH --nodes=1
...
#parameters
path_to_configfile="/mnt/beegfs02/pipelines/bigr_single-cell/2.0.0/examples/complete_grouped_integrated_analysis_example_of_wiki/Params_int_harmony.yaml"
